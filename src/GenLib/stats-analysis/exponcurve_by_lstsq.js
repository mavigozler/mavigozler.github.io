...
/*
	ALGORITHM AS 212  APPL.STATIST. (1985) VOL.34, NO.2

	FITS EXPONENTIAL CURVE  E(Y) = G0 + G1*(1-EXP(P*X))/P  USING
	MODIFIED NEWTON ITERATIONS ON P AFTER ELIMINATING G0 AND G1
*/
...
//        CONSTANTS  -  EPS IS MACHINE DEPENDENT
...
//         CONSTANTS  -  EPS IS MACHINE DEPENDENT
      ...
      if (Math.abs(xp) < one)
   	...
   	do {
			TERM = TERM * (AI + TWO) / AI / (AI + THREE) * XP
      	SERIES = SERIES + TERM
      	AI = AI + ONE
