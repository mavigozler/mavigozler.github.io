...
// ========================================
const HtmlReadFile = "src/base.html", HtmlWriteIndexFile = "gh-pages/index.html", HtmlWriteStaticFile = "gh-pages/static.html";
const CSSfiles = [
...
function processCss() {
    return new Promise((resolve, reject) => {
        ...
        for (const cssFile of CSSfiles)
            processOp.push(new Promise((resolve, reject) => {
        ...
        Promise.all(processOp).then((responses) => {
...
main();
//# sourceMappingURL=tunescript.js.map