...
function renderQuestions(data: MultipleChoiceQ[]) {
   const container = document.getElementById('rendered-questions') as HTMLDivElement;
...
(document.getElementById('generatePdfBtn') as HTMLButtonElement).addEventListener('click', () => {
   window.print();
});
...
document.addEventListener('DOMContentLoaded', () => {
   try {
         ...
         const container = document.getElementById('questions-container') as HTMLDivElement;
